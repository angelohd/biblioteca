...
<body class="">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Cadastros</span><span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="form_basic.html">Useres</a></li>
    ...
    <script src="{{ url('dist/js/plugins/metisMenu/jquery.metisMenu.js') }}"></script>
    <script src="{{ url('dist/js/plugins/slimscroll/jquery.slimscroll.min.js') }}"></script>

    <!-- Custom and plugin javascript -->
    <script src="{{ url('dist/js/inspinia.js') }}"></script>
    <script src="{{ url('dist/js/plugins/pace/pace.min.js') }}"></script>
    @yield('js')
